...
- [x] Matching quality tuning guidance documented with deterministic long-media/strictness presets, explicit `--chunk 0` stability caveat, fuzzy-match pitfalls cross-link, and CLI defaults regression coverage for discoverability (`docs/CLI.md`, `docs/Integration-issues.md`, `tests/test_cli.py`, `docs/STATUS.md`)
